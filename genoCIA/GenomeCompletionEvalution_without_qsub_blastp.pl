...
sub processFile { 
	...
	`/usr/global/blp/bin/formatdb -i $file -p T -t $DBname -n $DBname`;
    }
	...
	#`perl /home/vnkoparde/scripts/analyzeBlastResults.v2.pl $bpout 1 > $blast_statfile `;
