...
perl /usr/global/blp/bin/GenomeCompletionEvalution_without_qsub_blastp.pl $project /gpfs_fs/data2/tol/scripts/GenomeCompletionByReferenceList/genelist_files/TcruziCL_ESM_proteins.fa blastp `pwd`
gzip *.bp
gzip *.blast
